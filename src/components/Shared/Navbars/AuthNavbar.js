          ...
          >
            {/* <ul className="flex flex-col lg:flex-row list-none mr-auto">
              <li className="flex items-center">
                ...
                >
                  <i className="lg:text-slate-100 text-slate-300 far fa-file-alt text-lg leading-lg mr-2" />{" "}
                  Docs
                </a>
              </li>
            </ul> */}
            <ul className="flex flex-col lg:flex-row list-none lg:ml-auto">
              ...
              {/* <li className="flex items-center">
                <a
                  ...
                  target="_blank"
                >
                  <i className="lg:text-slate-100 text-slate-300 fab fa-facebook text-lg leading-lg " />
              ...
              <li className="flex items-center">
                <a
                  ...
                  target="_blank"
                >
                  <i className="lg:text-slate-100 text-slate-300 fab fa-twitter text-lg leading-lg " />
              ...
              <li className="flex items-center">
                <a
                  ...
                  target="_blank"
                >
                  <i className="lg:text-slate-100 text-slate-300 fab fa-github text-lg leading-lg " />
